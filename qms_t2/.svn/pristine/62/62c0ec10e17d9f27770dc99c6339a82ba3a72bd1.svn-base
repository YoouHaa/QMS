						...
						<div style="width: 49%;">
							<table class="fancy-table" style="table-layout: fixed; width: 100%;">
								<tr>
									...
									<td style="width: 25%;"><input type='text' style="width: 90%;" readonly id="docNo"></td>
							...
							<table class="fancy-table" id="lineTable">
								<thead>
									<tr>
										...
										<th scope="col" style="width: 10%; justify-content: center;">삭제</th>
									</tr>
								</thead>
								<tbody id="userData">
							...
							<div>
								<h5 style="display: flex; justify-content: space-between;">
									<strong>첨부파일</strong> <label for="fileInput">
										<div class="icon">
							...
							<table class="fancy-table">
								<thead>
									<tr>
										...
										<th scope="col" style="width: 55%;">파일명</th>
										<th scope="col" style="width: 18%;">파일크기</th>
						...
						<div style="width: 49%;">
							<table class="fancy-table" style="table-layout: fixed; width: 100%;">
								...
								<tr>
									...
									<td colspan="3" style="width: 75%;"><textarea id="content" name="content" class="form-control" rows="20" style="width: 100%;"></textarea></td>
								</tr>
							</table>
							<br>
